...
libgame.a: game_play.cpp game_graphic.cpp game_progress.cpp stage_data.o loadg.o DxLib.o
	...
	ar rcs  -o libgame.a game_progress.o game_play.o game_graphic.o  stage_data.o loadg.o DxLib.o  

stage_data.o: stage_data.cpp
	gcc -g -c stage_data.cpp  `sdl-config --libs` -lm -lSDL_gfx -lSDL_image -lSDL_mixer -lSDL_ttf -lstdc++ -DDEBUG
